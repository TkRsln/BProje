...
#./dataset_1/model_class/
class ModelBaseTrainDataset(Dataset):
    def __init__(self, scale=1,root_dir='C:/Users/utkua/OneDrive/Masaüstü/AI/dataset_1/model_class/',model_key='model_',cloth_key='tshirt',print_info:bool=False,gry=False):
    ...
    def img_to_tensor(self,path):
        ...
        target_image = target_image.resize((int(image_size[0]*self.scale), int(image_size[1]*self.scale)))
        ...
        return transform(target_image)#target_image
...
if __name__ == '__main__':
    ...
    dataset=ModelBaseTrainDataset(scale=0.5,gry=True,print_info=True)
    
    print(dataset.get_tensor_data(55)[0][0].shape)
    #print(info)
