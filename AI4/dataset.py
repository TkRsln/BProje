...
class ModelBaseTrainDataset(Dataset):
    def __init__(self, scale=1,root_dir='./dataset_1/model_class/',model_key='model_',cloth_key='tshirt',print_info:bool=False,gry=False):
...
if __name__ == '__main__':
    ...
    dataset=ModelBaseTrainDataset(scale=0.5,print_info=True)
